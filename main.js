const servers = {
  iceServers: [
    ...
    {url:'stun:stun.counterpath.com'},
    {
      ...
      credential: 'jdjhthfjwap',
      username: 'fedario@gmail.com'
    }
  ]
};
...
function createPeerConnectionFor(username) {
  if (peerConnections[username] && peerConnections[username].signalingState != 'closed') {
...
function removeConnectionFor(username) {
  document.getElementById('video-' + username).remove();
  peerConnections[username].close();
}
